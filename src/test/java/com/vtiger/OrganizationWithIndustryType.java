...
public class OrganizationWithIndustryType {
	public static void main(String[] args) throws Throwable {
		...
		WebElement createOrganizationButton = driver
				.findElement(By.xpath("//img[@src='themes/softed/images/btnL3Add.gif']"));
		createOrganizationButton.click();

		WebElement organizationName = driver.findElement(By.name("accountname"));
		organizationName.sendKeys("Fortune1");

		WebElement webSiteTf = driver.findElement(By.name("website"));
		webSiteTf.sendKeys("www.fortune9.com");

		WebElement organizationPlusButton = driver
				.findElement(By.xpath("//img[@src='themes/softed/images/select.gif']"));
		...
		WebElement industryDd = driver.findElement(By.xpath("//select[@name='industry']/option[4]"));
		industryDd.click();
		...
		actions.moveToElement(administratorImage).perform();
